...
namespace paypart_item_gateway
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "paypart item gateway", Version = "v1" });
            });
            services.AddTransient<IItemSqlServerRepository, ItemSqlServerRepository>();
            ...
            //SQL Server
            services.AddDbContext<ItemSqlServerContext>(options => options.UseSqlServer(
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "paypart item gateway v1");
            });
